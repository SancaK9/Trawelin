(() => {
                ...
                beginInvokeJSFromDotNet: (e, t, n, r, o) => {
                    ...
                    e &&
                        s.then(
                            ...
                            (t) => w().endInvokeJSFromDotNet(e, !1, JSON.stringify([e, !1, E(t)]))
                        );
                },
    ...
    l(["input", "change"], {
        ...
        l(["contextmenu", "click", "mouseover", "mouseout", "mousemove", "mousedown", "mouseup", "dblclick"], { createEventArgs: (e) => d(e) }),
        l(["error"], {
            createEventArgs: (e) => {
        ...
        l(["touchcancel", "touchend", "touchmove", "touchenter", "touchleave", "touchstart"], {
            createEventArgs: (e) => {
                return { detail: (t = e).detail, touches: u(t.touches), targetTouches: u(t.targetTouches), changedTouches: u(t.changedTouches), ctrlKey: t.ctrlKey, shiftKey: t.shiftKey, altKey: t.altKey, metaKey: t.metaKey, type: t.type };
                var t;
            },
        }),
        l(["gotpointercapture", "lostpointercapture", "pointercancel", "pointerdown", "pointerenter", "pointerleave", "pointermove", "pointerout", "pointerover", "pointerup"], {
            createEventArgs: (e) => {
                return { ...d((t = e)), pointerId: t.pointerId, width: t.width, height: t.height, pressure: t.pressure, tiltX: t.tiltX, tiltY: t.tiltY, pointerType: t.pointerType, isPrimary: t.isPrimary };
                var t;
            },
        }),
        l(["wheel", "mousewheel"], {
    ...
    class k {
        ...
        setListener(e, t, n, r) {
            ...
            if (s) this.eventInfoStore.update(s.eventHandlerId, n);
                ...
                const s = { element: e, eventName: t, eventHandlerId: n, renderingComponentId: r };
            ...
            for (; o;) {
                ...
                if (m) {
                    ...
                    if (n && ((u = f), (d = t.type), !((u instanceof HTMLButtonElement || u instanceof HTMLInputElement || u instanceof HTMLTextAreaElement || u instanceof HTMLSelectElement) && O.hasOwnProperty(d) && u.disabled))) {
                        ...
                        R.hasOwnProperty(t.type) && t.preventDefault(), N(this.browserRendererId, { eventHandlerId: n.eventHandlerId, eventName: e, eventFieldInfo: r.fromEvent(n.renderingComponentId, t) }, s);
                    }
    ...
    e.attachReviver((e, t) =>
        t && "object" == typeof t && t.hasOwnProperty("__internalId") && "string" == typeof t.__internalId
            ? (function (e) {
                const t = `[${q(e)}]`;
            ...
            for (let s = h; s < p; s++) {
                ...
                switch (h) {
                    ...
                    case t.permutationListEntry:
                        (i = i || []), i.push({ fromSiblingIndex: l + d.siblingIndex(u), toSiblingIndex: l + d.moveToSiblingIndex(u) });
                        break;
    ...
    const Ce = {
        ...
        Ae = {
            init: function (e, t, n, r = 50) {
                ...
                const a = new IntersectionObserver(
                    function (r) {
                        r.forEach((r) => {
                            ...
                            r.target === t
                                ? e.invokeMethodAsync("OnSpacerBeforeVisible", r.intersectionRect.top - r.boundingClientRect.top, a, i)
                                : r.target === n && n.offsetHeight > 0 && e.invokeMethodAsync("OnSpacerAfterVisible", r.boundingClientRect.bottom - r.intersectionRect.bottom, a, i);
                        });
                    },
                ...
                function u(e) {
                    return (
                        null !== e && ((e instanceof HTMLTableElement && "" === e.style.display) || "table" === e.style.display || (e instanceof HTMLTableSectionElement && "" === e.style.display) || "table-row-group" === e.style.display)
                    );
                }
                Se[e._id] = { intersectionObserver: a, mutationObserverBefore: i, mutationObserverAfter: c };
            },
            dispose: function (e) {
                const t = Se[e._id];
        ...
        ke = {
            ...
            toImageFile: async function (e, t, n, r, o) {
                const s = De(e, t),
                    ...
                    c = { id: ++e._blazorInputFileNextFileId, lastModified: s.lastModified, name: s.name, size: (null == i ? void 0 : i.size) || 0, contentType: n, blob: i || s.blob };
    ...
    class Je {
        ...
        static async initAsync(e, t) {
            ...
            async function a(e) {
                return fetch(e, { method: "GET", credentials: "include", cache: "no-cache" });
            }
        }
    }
    var Ue;
        ...
        start: function (t) {
            return new Promise((n, r) => {
                (function (e) {
                    ...
                    xe() && console.info(`Debugging hotkey: Shift+${t}+D (when application has focus)`),
                    ...
                    (function (o) {
                        ...
                        (window.__wasmmodulecallback__ = () => {
                            (window.Module = (function (t, n, r) {
                                ...
                                let f, m;
                                if (
                                    (t.bootConfig.resources.runtime.hasOwnProperty(d) && (f = t.loadResource(d, "_framework/dotnet.timezones.blat", t.bootConfig.resources.runtime["dotnet.timezones.blat"], "globalization")),
                                ...
                                return (
                                    ...
                                    s.preRun.push(() => {
                                        (ze = cwrap("mono_wasm_add_assembly", null, ["string", "number", "number"])),
                                            (MONO.loaded_files = []),
                                            f &&
                                            (async function (e) {
                                                ...
                                                Module.FS_createPath("/", "usr", !0, !0),
                                                    ...
                                                    Module.FS_createPath("/usr/share/", "zoneinfo", !0, !0),
                                                    MONO.mono_wasm_load_data_archive(new Uint8Array(r), "/usr/share/zoneinfo/"),
                                                ...
                                                if ((t.startOptions.applicationCulture || (navigator.languages && navigator.languages[0]), r)) {
                                                    const e = Promise.all(
                                                        n
                                                            ...
                                                            .map((e) => t.loadResources(r[e], (e) => `_framework/${e}`, "assembly"))
                                    ...
                                    s.postRun.push(() => {
                                        t.bootConfig.debugBuild && t.bootConfig.cacheBootResources && t.logToConsole(),
                                            t.purgeUnusedCacheEntriesAsync(),
                                            t.bootConfig.icuDataMode === Ue.Sharded &&
                                            (MONO.mono_wasm_setenv("__BLAZOR_SHARDED_ICU", "1"), t.startOptions.applicationCulture && MONO.mono_wasm_setenv("LANG", `${t.startOptions.applicationCulture}.UTF-8`));
                                        let r = "UTC";
                                        try {
                                            r = Intl.DateTimeFormat().resolvedOptions().timeZone;
                                        } catch (error){ }
                                        MONO.mono_wasm_setenv("TZ", r || "UTC"),
                                            t.bootConfig.modifiableAssemblies && MONO.mono_wasm_setenv("DOTNET_MODIFIABLE_ASSEMBLIES", t.bootConfig.modifiableAssemblies),
                                            t.bootConfig.aspnetCoreBrowserTools && MONO.mono_wasm_setenv("__ASPNETCORE_BROWSER_TOOLS", t.bootConfig.aspnetCoreBrowserTools),
                                            cwrap("mono_wasm_load_runtime", null, ["string", "number"])("appBinDir", xe() ? -1 : 0),
    ...
    const ot = { structLength: 8, values: (e) => Te.readObjectField(e, 0), count: (e) => Te.readInt32Field(e, 4) },
        st = {
            structLength: 12,
            values: (e) => {
        ...
        at = { structLength: 4 + st.structLength, componentId: (e) => Te.readInt32Field(e, 0), edits: (e) => Te.readStructField(e, 4), editsEntry: (e, t) => lt(e, t, it.structLength) },
        it = {
            structLength: 20,
    ...
    class ut {
        ...
        loadResource(e, t, n, r) {
            return { name: e, url: t, response: this.cacheIfUsed ? this.loadResourceWithCaching(this.cacheIfUsed, e, t, n, r) : this.loadResourceWithoutCaching(e, t, n, r) };
        }
        logToConsole() {
            ...
            console.groupCollapsed(`%cblazor%c Loaded ${ft(o)} resources${s}`, "background: purple; color: white; padding: 1px 3px; border-radius: 3px;", "font-weight: bold;", "font-weight: normal;"),
                e.length && (console.groupCollapsed(`Loaded ${ft(n)} resources from cache`), console.table(this.cacheLoads), console.groupEnd()),
                t.length && (console.groupCollapsed(`Loaded ${ft(r)} resources from network`), console.table(this.networkLoads), console.groupEnd()),
                console.groupEnd();
        }
        ...
        async addToCacheAsync(e, t, n, r) {
            ...
            const i = new Response(o, { headers: { "content-type": r.headers.get("content-type") || "", "content-length": (a || r.headers.get("content-length") || "").toString() } });
            try {
                await e.put(n, i);
            } catch (e) { }
        }
    ...
    class mt {
        static async initAsync(e) {
            ...
            const t = await Promise.all((e.bootConfig.config || []).filter((t) => "appsettings.json" === t || t === `appsettings.${e.applicationEnvironment}.json`).map(async (e) => ({ name: e, content: await n(e) })));
            async function n(e) {
                const t = await fetch(e, { method: "GET", credentials: "include", cache: "no-cache" });
                ...
                switch (t) {
                    case "webassembly":
                        return (function (e, t, n) {
                            const { type: r, assembly: o, typeName: s, parameterDefinitions: a, parameterValues: i, prerenderId: c } = e;
                            if ("webassembly" === r) {
                                ...
                                if (c) {
                                    ...
                                    return { type: r, assembly: o, typeName: s, parameterDefinitions: a && atob(a), parameterValues: i && atob(i), start: t, prerenderId: c, end: e };
                                }
                                return { type: r, assembly: o, typeName: s, parameterDefinitions: a && atob(a), parameterValues: i && atob(i), start: t };
                            }
                        })(r, n, e);
                    case "server":
                        return (function (e, t, n) {
                            ...
                            if ("server" === r) {
                                ...
                                if (a) {
                                    const e = vt(a, n);
                                    if (!e) throw new Error(`Could not find an end component comment for '${t}'`);
                                    return { type: r, sequence: s, descriptor: o, start: t, prerenderId: a, end: e };
                                }
    ...
    async function At(t) {
        ...
        (Ct = !0),
            ...
            (Fe._internal.getApplyUpdateCapabilities = () => e.invokeMethod("Microsoft.AspNetCore.Components.WebAssembly", "GetApplyUpdateCapabilities")),
        ...
        (Fe._internal.navigationManager.getUnmarshalledBaseURI = () => BINDING.js_string_to_mono_string(r())),
            (Fe._internal.navigationManager.getUnmarshalledLocationHref = () => BINDING.js_string_to_mono_string(o())),
        ...
        (Fe._internal.registeredComponents = {
            ...
            (Fe._internal.getPersistedState = () => BINDING.js_string_to_mono_string(yt(document) || "")),
        ...
        const u = await i,
            ...
            [f] = await Promise.all([ut.initAsync(u.bootConfig, s || {}), mt.initAsync(u)]);
        try {
            await n.start(f);
        } catch (e) {
